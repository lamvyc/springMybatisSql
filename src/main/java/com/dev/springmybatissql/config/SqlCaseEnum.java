...
public enum SqlCaseEnum {
    ...
    CASE_05(5L, "不用MAX函数求最高薪资（经典第5题）",
            ...
            "order by、limit、替代方案",
            "面试常问两种解法：排序取第一条、或者用 NOT EXISTS 找没有比自己更高的员工",
            "进阶", "order by/limit",
    ...
    SqlCaseEnum(Long id, String title,
                ...
                String difficulty, String knowledgePoint, String standardSql) {
        this.id = id;
        this.title = title;
    ...
    /**
     * 懒计算 description：拼接涉及的表结构图 + 分析/知识/面试表达
     */
    public String getDescription() {
        ...
        sb.append("【面试表达】").append(interview);
        return sb.toString();
    }
}